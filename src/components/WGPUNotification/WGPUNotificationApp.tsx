      ...
      <div class="flex items-center mb-4">
        <div class="w-8 h-8 mr-3 flex-shrink-0">
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
            class="w-full h-full text-purple-900"
          >
        ...
        <Show when={isChecking()} fallback={<div class="space-y-4">
            ...
            <div class="p-4 bg-blue-50 border-2 border-blue-300 rounded">
              ...
              <p class="text-sm text-blue-700">
                This application uses WebGPU for high-performance 3D graphics
                and compute operations. WebGPU provides direct access to modern
                GPU capabilities, enabling smooth 3D rendering and advanced
                visual effects.
              </p>
            </div>
            ...
            <div class="p-4 bg-gray-50 border-2 border-gray-300 rounded">
              ...
              <p class="text-sm text-gray-700">
                If you're having trouble with WebGPU support, make sure your
                graphics drivers are up to date and you're using a supported
                browser. Some corporate networks or security software may also
                block WebGPU access.
              </p>
            </div>
